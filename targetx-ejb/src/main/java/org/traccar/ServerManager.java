...
public class ServerManager {
    ...
    public ServerManager() throws Exception {
        ...
        Log.info("Automatically registered device ");
        if (packageUrl.getProtocol().equals("jar")) {
            ...
            File folder = new File(packageUrl.toString());
...
//        if (Context.getConfig().hasKey(protocol.getName() + ".port")) {5027
